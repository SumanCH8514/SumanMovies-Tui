...
use sumanmovies_tui::tui::overlay::update_modal_layout;
use sumanmovies_tui::updater::apply::{
...
async fn test_update_editing_mode_input_isolation() {
    ...
    app.state_mut().input_mode = sumanmovies_tui::tui::state::InputMode::Editing;
