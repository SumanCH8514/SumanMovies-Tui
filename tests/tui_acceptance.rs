...
async fn test_mouse_click_favorites_item_focuses_and_selects() {
    ...
    app.state_mut()
        .favorites
        .items
        .push(sumanmovies_tui::favorites::FavoriteItem {
...
async fn test_mouse_click_search_suggestion_selects_query() {
    ...
    let (_container, inner) =
        sumanmovies_tui::tui::screens::home::search_suggestions_bounds(area, search_bar_area, 2);
...
async fn test_f_key_toggles_favorite_on_home_results() {
    ...
    let identity = sumanmovies_tui::models::SubjectIdentity {
...
async fn test_contextual_window_title() {
    ...
    app.state_mut().selected_details = Some(sumanmovies_tui::models::MediaDetails {
        id: sumanmovies_tui::models::ProviderMediaId {
            provider: sumanmovies_tui::models::ProviderKind::MovieBox,
            value: "1".to_string(),
        },
        title: "Inception".to_string(),
        media_type: sumanmovies_tui::models::MediaType::Movie,
        year: None,
        description: None,
        tagline: None,
        imdb_rating: None,
...
async fn test_home_deck_tab_switching() {
    ...
    app.state_mut()
        .history
        .recent
        .push(sumanmovies_tui::history::WatchHistoryItem {
            provider: "moviebox".to_string(),
    ...
    assert_eq!(
        ...
        sumanmovies_tui::tui::state::HomeDeckTab::ContinueWatching
    );
    ...
    assert_eq!(
        app.state().effective_home_deck_tab(),
        sumanmovies_tui::tui::state::HomeDeckTab::Favorites
    );
