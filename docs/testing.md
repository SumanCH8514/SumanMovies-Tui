...
This document describes the testing architecture, quality assurance procedures, and validation guidelines for SumanMovies-TUI.
...
The SumanMovies-TUI test architecture follows a strict separation of concerns:
...
All performance optimizations in SumanMovies-TUI must be backed by empirical before-and-after measurements. Changes without quantitative verification must be classified as refactors or code cleanups, not performance improvements.
