...
impl TargetPlatform {
    ...
    pub fn expected_asset_name(self) -> &'static str {
        match self {
            Self::MacosUniversal => "SumanMovies_macOS_Universal.tar.gz",
            Self::LinuxX64 => "SumanMovies_Linux_x64.tar.gz",
            Self::LinuxArm64 => "SumanMovies_Linux_arm64.tar.gz",
            Self::WindowsX64 => "SumanMovies_Windows_x64.zip",
            Self::WindowsArm64 => "SumanMovies_Windows_arm64.zip",
        }
    }
    ...
    pub fn find_compatible_asset(&self, platform: TargetPlatform) -> Option<ReleaseAsset> {
        ...
        if self.assets.is_empty() && !self.tag_name.is_empty() {
            return Some(ReleaseAsset {
                ...
                download_url: format!(
                    "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/{}/{expected}",
                    self.tag_name
                ),
                size: None,
            });
    ...
    pub fn find_checksum_asset(&self) -> Option<ReleaseAsset> {
        ...
        if self.assets.is_empty() && !self.tag_name.is_empty() {
            return Some(ReleaseAsset {
                ...
                download_url: format!(
                    "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/{}/SHA256SUMS",
                    self.tag_name
                ),
                size: None,
            });
...
mod tests {
    ...
    fn test_synthetic_asset_url_generation_on_empty_assets() {
        ...
        assert_eq!(linux_asset.name, "SumanMovies_Linux_x64.tar.gz");
        assert_eq!(
            linux_asset.download_url,
            "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.16/SumanMovies_Linux_x64.tar.gz"
        );
        ...
        assert_eq!(
            ...
            "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.16/SumanMovies_macOS_Universal.tar.gz"
        );
        ...
        assert_eq!(
            ...
            "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.16/SHA256SUMS"
        );
    }
