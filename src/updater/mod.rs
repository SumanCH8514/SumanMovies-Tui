    ...
    match env {
        InstallationEnvironment::Homebrew => {
            return Ok(SelfUpdateOutcome::RequiresManualUpgrade(
                "This installation is managed by Homebrew. Run: brew upgrade sumanmovies"
                    .to_string(),
            ));
        }
...
mod tests {
    ...
    fn sample_release_with_all_assets() -> Release {
        Release {
            ...
            assets: vec![
                ReleaseAsset {
                    name: "SumanMovies_macOS_Universal.tar.gz".to_string(),
                    download_url: "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.13/SumanMovies_macOS_Universal.tar.gz".to_string(),
                    size: Some(15_000_000),
                },
                ReleaseAsset {
                    name: "SumanMovies_Linux_x64.tar.gz".to_string(),
                    download_url: "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.13/SumanMovies_Linux_x64.tar.gz".to_string(),
                    size: Some(12_000_000),
                },
                ReleaseAsset {
                    name: "SumanMovies_Linux_arm64.tar.gz".to_string(),
                    download_url: "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.13/SumanMovies_Linux_arm64.tar.gz".to_string(),
                    size: Some(11_500_000),
                },
                ReleaseAsset {
                    name: "SumanMovies_Windows_x64.zip".to_string(),
                    download_url: "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.13/SumanMovies_Windows_x64.zip".to_string(),
                    size: Some(13_000_000),
                },
                ReleaseAsset {
                    name: "SumanMovies_Windows_arm64.zip".to_string(),
                    download_url: "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.13/SumanMovies_Windows_arm64.zip".to_string(),
                    size: Some(12_500_000),
                },
                ReleaseAsset {
                    name: "SHA256SUMS".to_string(),
                    download_url: "https://github.com/SumanCH8514/SumanMovies-Tui/releases/download/v0.1.13/SHA256SUMS".to_string(),
                    size: Some(512),
                },
            ],
        }
    ...
    fn test_update_asset_selection_for_current_platform() {
        ...
        assert_eq!(mac_asset.name, "SumanMovies_macOS_Universal.tar.gz");
        ...
        assert_eq!(linux_x64_asset.name, "SumanMovies_Linux_x64.tar.gz");
        ...
        assert_eq!(linux_arm64_asset.name, "SumanMovies_Linux_arm64.tar.gz");
        ...
        assert_eq!(win_x64_asset.name, "SumanMovies_Windows_x64.zip");
        ...
        assert_eq!(win_arm64_asset.name, "SumanMovies_Windows_arm64.zip");
    ...
    fn test_update_asset_multiple_candidates_deterministic() {
        ...
        assert_eq!(a1, a2);
        assert_eq!(a1.unwrap().name, "SumanMovies_Linux_x64.tar.gz");
    }
}
