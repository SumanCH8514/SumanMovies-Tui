...
mod tests {
    ...
    fn persistent_staging_path_lives_beside_executable() {
        let exe = Path::new("/opt/tools/sumanmovies-tui.exe");
    ...
    fn stale_artifacts_cover_staging_and_helper() {
        let exe = Path::new("C:/App/sumanmovies-tui.exe");
    ...
    fn helper_script_waits_moves_and_cleans_up() {
        let script = render_helper_script(
            ...
            Path::new("C:\\App\\sumanmovies-tui.exe"),
            4242,
        );
        ...
        assert!(script.contains(
            "move /y \"C:\\App\\update dir\\.moviebox_update_staged.exe\" \"C:\\App\\sumanmovies-tui.exe\" >NUL 2>&1"
        ));
        ...
        assert!(script.contains("start \"\" \"C:\\App\\sumanmovies-tui.exe\""));
    ...
    fn cleanup_removes_only_known_artifacts() {
        ...
        let exe = dir.join("sumanmovies-tui.exe");
